...
namespace Slac_DataAnalysis
{
    ...
    //        //Application.Run(new frm_main_yzyl_bit());
    ...
    internal static class Program
    {
        ...
        {
            bool isRuning = true;
            //mutex = new System.Threading.Mutex(true, "OnlyRunOneInstance_002", out isRuning); // 如果互斥锁成功创建，isRuning 将被设置为 false；如果互斥锁已经存在，isRuning 将被设置为 true
